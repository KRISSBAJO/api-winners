...
export const PERMISSIONS = {
 ...
 /* Pastors (directory & profile) */
  ...
  CELL_MEETING_CREATE: "cell.meeting.create",
  CELL_MEETING_UPDATE: "cell.meeting.update",
  CELL_MEETING_DELETE: "cell.meeting.delete",
  CELL_REPORT_SUBMIT: "cell.report.submit",
  CELL_REPORT_READ: "cell.report.read",
  ...
  /* Volunteer / Ministry Groups */
GLOBAL_GROUP_CREATE: "group.create",
GLOBAL_GROUP_READ: "group.read",
GLOBAL_GROUP_UPDATE: "group.update",
GLOBAL_GROUP_DELETE: "group.delete",

/* Occurrences (group meetings) */
OCCURRENCE_CREATE: "occurrence.create",
OCCURRENCE_READ: "occurrence.read",
OCCURRENCE_UPDATE: "occurrence.update",
OCCURRENCE_DELETE: "occurrence.delete",

/* Group requests (moderation) */
GROUP_REQUEST_READ: "group.request.read",
GROUP_REQUEST_HANDLE: "group.request.handle",
...
export const ROLE_MATRIX: Record<string, PermissionKey[]> = {
  ...
  nationalPastor: [
    ...
    PERMISSIONS.CELL_CREATE, PERMISSIONS.CELL_UPDATE, PERMISSIONS.CELL_DELETE,
    PERMISSIONS.CELL_MEETING_CREATE, PERMISSIONS.CELL_MEETING_UPDATE, PERMISSIONS.CELL_MEETING_DELETE,
    PERMISSIONS.CELL_REPORT_SUBMIT, PERMISSIONS.CELL_REPORT_UPDATE, PERMISSIONS.CELL_REPORT_DELETE, PERMISSIONS.CELL_ANALYTICS,
  ],
  ...
  districtPastor: [
    ...
    PERMISSIONS.CELL_CREATE, PERMISSIONS.CELL_UPDATE,
    PERMISSIONS.CELL_MEETING_CREATE, PERMISSIONS.CELL_MEETING_UPDATE,
    PERMISSIONS.CELL_REPORT_SUBMIT, PERMISSIONS.CELL_ANALYTICS,
  ],
  ...
  churchAdmin: [
    ...
    PERMISSIONS.MEMBER_CREATE, PERMISSIONS.MEMBER_READ, PERMISSIONS.MEMBER_UPDATE, PERMISSIONS.MEMBER_DELETE, PERMISSIONS.MEMBER_BY_CHURCH,
    ...
    PERMISSIONS.CELL_CREATE, PERMISSIONS.CELL_UPDATE, PERMISSIONS.CELL_DELETE, PERMISSIONS.CELL_READ, PERMISSIONS.CELL_REPORT_READ,
    PERMISSIONS.CELL_MEETING_CREATE, PERMISSIONS.CELL_MEETING_UPDATE, PERMISSIONS.CELL_MEETING_DELETE,
    PERMISSIONS.CELL_REPORT_SUBMIT, PERMISSIONS.CELL_REPORT_UPDATE, PERMISSIONS.CELL_REPORT_DELETE, PERMISSIONS.CELL_ANALYTICS,
  ],
  ...
  volunteer: [
    ...
    PERMISSIONS.CELL_READ, PERMISSIONS.CELL_ANALYTICS, PERMISSIONS.CELL_CREATE, PERMISSIONS.CELL_UPDATE, PERMISSIONS.CELL_DELETE,
    PERMISSIONS.CELL_MEETING_CREATE, PERMISSIONS.CELL_MEETING_UPDATE, PERMISSIONS.CELL_MEETING_DELETE,
    PERMISSIONS.CELL_REPORT_UPDATE, PERMISSIONS.CELL_REPORT_DELETE,PERMISSIONS.CELL_REPORT_READ, PERMISSIONS.CELL_REPORT_SUBMIT,
  ],
};
